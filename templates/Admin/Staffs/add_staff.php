              ...
              <div class="row">
                <div class="col-sm-6">
                  <div class="form-group">
                    ...
                    <textarea name="designation" id="designation" rows="3" placeholder="Enter designation" class="form-control"></textarea>
                  </div>
                </div>
                <div class="col-sm-6">
                  <div class="form-group">
                    <label for="">Select Type<span class="character-required">*</span></label>
